    ...
    <div className="overflow-hidden rounded-2xl border border-border bg-card/70 backdrop-blur-xl">
      ...
      <div className="px-5 pt-4">
        ...
        <div className="relative">
          ...
          {mentionOpen && (
            <div className="absolute bottom-[calc(100%+24px)] left-0 w-72 bg-[#1A1A1A]/95 border border-white/10 rounded-2xl shadow-2xl backdrop-blur-xl overflow-hidden z-[99999] animate-in fade-in slide-in-from-bottom-2 duration-200">
